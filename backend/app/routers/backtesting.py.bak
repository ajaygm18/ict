...
class BacktestEngine:
    ...
    def _execute_trades(self, data: pd.DataFrame, signals: list):
        ...
        # For demo purposes, simulate some successful trades
        for i, signal in enumerate(signals[:20]):  # Limit to 20 trades for demo
            try:
                ...
                if stop_distance == 0:
                    stop_distance = signal.entry_price * 0.01  # Default 1% stop
                ...
                if signal.confidence > 0.7:
                    ...
                    profit = (signal.take_profit - signal.entry_price) * position_size
                    if signal.signal_type == "SELL":
                        profit = (signal.entry_price - signal.take_profit) * position_size
                    ...
                    loss = abs(signal.entry_price - signal.stop_loss) * position_size
